...
SEND_INTERVAL = 5
DATA_TIMEOUT = 30
BAUDRATE_FALLBACKS = [38400, 9600, 4800, 115200]

# ============================== ACCURACY THRESHOLDS FOR u-blox ZED-F9P ==============================
MIN_SATELLITES_FOR_RTK = 4
RTK_HORIZONTAL_ACCURACY = 0.01
RTK_VERTICAL_ACCURACY = 0.01
RTK_HEADING_ACCURACY = 0.3
DGPS_HORIZONTAL_ACCURACY = 0.25
STANDALONE_ACCURACY = 2.5
        ...
        try:
            ...
            if current_time - last_send_time >= SEND_INTERVAL:
                ...
                try:
                    ...
                    websocket_data_logger.info(json.dumps(gps_data))
