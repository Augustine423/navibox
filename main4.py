...
STATIONARY_THRESHOLD = 0.00002         # ~2.2 meters — below this, the device is considered stationary
UPDATE_COOLDOWN = 2                    # seconds — minimum interval between accepted position updates
...
MIN_ACCURACY_THRESHOLD = 10.0          # meters — maximum acceptable horizontal accuracy
